  ...
  const pythonCourses = [
    {
      title: "Python",
      description:
        "Aprende fundamentos de programación como variables, control de flujo y bucles con el lenguaje de programación más popular y versátil del mundo: ¡Python!",
    ...
    },
    {
      ...
      description:
        "Comienza a aprender Python intermedio con estructuras de datos.",
    ...
    },
    {
      title: "NumPy",
      description:
        "¡Aprende los fundamentos de manipulación de datos usando NumPy! Aprende a programar usando NumPy con Codedex, ¡gratis!",
  ...
  const webCourses = [
    {
      title: "HTML",
      description:
        "Crea tu primer sitio web con HTML, los bloques de construcción de la web, y sumérgete en el mundo del desarrollo web.",
    ...
    },
    {
      title: "CSS",
      description:
        "¡Aprende a usar selectores y propiedades CSS para estilizar tus páginas HTML con colores, fuentes, tamaños, diseños y más!",
    ...
    },
    {
      title: "JavaScript",
      description:
        "¡Aprende variables, bucles, funciones y eventos para comenzar a construir aplicaciones web interactivas con el lenguaje de programación de la web — JavaScript!",
    ...
    <section className="py-16 bg-codedex-darkNavy">
      <div className="codedex-container">
        ...
        <p className="text-lg text-gray-300 mb-10">
          Aprende a programar con cursos divertidos e interactivos creados por
          expertos de la industria y educadores.
        </p>
