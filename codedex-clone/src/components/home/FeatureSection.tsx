  ...
  const features = [
    {
      ...
      description: 'Gana XP y colecciona insignias a medida que completas lecciones breves en Python, HTML, JavaScript y más. Nuestro plan de estudios amigable para principiantes hace que aprender a programar sea tan motivador como completar tu próxima misión.',
    ...
    },
    {
      ...
      description: 'Crea tus propios sitios web interactivos, mini-juegos, aplicaciones móviles, visualizaciones de datos y presúmelos a tus amigos o al mundo, todo en Codedex.',
      imageSrc: 'https://ext.same-assets.com/1748103887/659665000.svg',
    },
    {
      id: 'community',
      title: 'Haz amigos en el camino',
      description: 'Construir es mucho mejor juntos que en solitario. Únete a nuestro foro comunitario y Discord para dar y recibir ayuda, colaborar en proyectos y conectarte a través de pasiones compartidas.',
