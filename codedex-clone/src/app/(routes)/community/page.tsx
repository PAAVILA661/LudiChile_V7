  ...
  const posts = [
    {
      ...
      channel: "General",
      content:
        "my pet died, im on steve harvey jr the third, the other two died",
      likes: 6,
      comments: 2,
    },
    {
      ...
      channel: "General",
      content:
        "Guess who just rode into town (NYC)!\n\nDrop a 🚀 emoji comment if you know :)",
      likes: 18,
      comments: 4,
    },
    {
      ...
      <div className="bg-gradient-to-b from-indigo-900/50 to-codedex-darkNavy pt-10 pb-4 mb-8">
        <div className="codedex-container">
          <div className="flex items-center gap-4 mb-4">
            ...
            />
            <div>
              <h1 className="text-3xl font-pixel text-white">
                Coddex Community
              </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 space-y-6">
            {posts.map((post) => (
              <Card
                key={post.id}
                className="bg-codedex-navy border-codedex-gold/10"
              >
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span
                          className={`text-xs px-2 py-0.5 rounded ${post.rank === "Gold" ? "bg-yellow-700" : "bg-amber-900"}`}
                        >
                          {post.rank} rank
                        </span>
                      </div>
          ...
          <div className="w-full lg:w-80 space-y-6">
            <Card className="bg-codedex-navy border-codedex-gold/10">
              <CardHeader>
                <CardTitle className="text-white font-pixel text-lg">
                  Codedex News
                </CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-4">
                  {news.map((item) => (
                    <li key={item.title}>
                      <Link
                        href={item.href}
                        className="block hover:bg-codedex-gold/5 p-2 rounded-md transition-colors"
                      >
