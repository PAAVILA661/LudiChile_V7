  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        if (!response.ok) {
          setApiError(data.message || 'Failed to login. Please check your credentials.');
          setIsLoading(false);
          return;
        }
    ...
    <div className="min-h-screen bg-codedex-darkNavy flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <h1 className="text-3xl font-pixel text-codedex-gold">Welcome Back</h1>
        ...
        <Card className="bg-codedex-navy border-codedex-gold/10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <Link href="/forgot-password" className="text-xs text-codedex-teal hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <Input
          ...
          <CardFooter className="flex justify-center border-t border-gray-800 pt-4">
            <p className="text-gray-400 text-sm">
              ...
              <Link href="/register" className="text-codedex-teal hover:underline">
                Sign Up
              </Link>
            </p>
          </CardFooter>
