      ...
      <div className="codedex-container py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            Unlock your full potential with our tailored plans designed for
          ...
          <Card className="bg-codedex-navy border border-codedex-gold/20 overflow-hidden">
            <CardContent className="p-0">
              <div className="p-8">
                ...
                <h2 className="font-pixel text-2xl text-white mb-1 text-center">
                  Explorer
                </h2>
                ...
                <p className="text-gray-300 mb-6 text-center">
                  Explore the world of coding with basic access to our learning
                  content and community.
                </p>
                <div className="flex justify-center mb-8">
                  <Button
                    className="w-full bg-transparent text-codedex-gold border border-codedex-gold/30 hover:bg-codedex-gold/10"
                    asChild
                  >
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-2">
                    ...
                    <span className="text-gray-300">
                      Access to first few chapters in many courses
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <svg
          ...
          <Card className="bg-codedex-navy border-2 border-codedex-gold overflow-hidden relative">
            ...
            <CardContent className="p-0">
              <div className="p-8">
                ...
                <h2 className="font-pixel text-2xl text-codedex-gold mb-1 text-center">
                  CLUB
                </h2>
                <div className="text-center mb-6">
                ...
                <div className="flex justify-center mb-8">
                  <Button
                    className="w-full bg-codedex-gold text-codedex-darkNavy hover:bg-codedex-gold/90"
                    asChild
                  >
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-2">
                    ...
                    <span className="text-gray-300">
                      Everything in <span className="font-bold">Explorer</span>,
                      plus...
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    ...
                    <span className="text-gray-300">
                      Full access to Club-only content
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <svg
        ...
        {/* Feature Comparison */}
        <div className="mt-24">
          <h2 className="text-3xl font-pixel text-codedex-gold mb-8 text-center">
            Compare Features
          </h2>
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              <thead>
                <tr>
                  <th className="text-left py-4 px-6 text-gray-400 font-normal">
                    Learning Content
                  </th>
              ...
              <tbody>
                <tr className="border-t border-codedex-gold/10">
                  <td className="py-4 px-6 text-white">
                    ...
                    <div className="text-sm text-gray-400">
                      Access to our library of standard and Club-only courses
                    </div>
                  </td>
                ...
                <tr className="border-t border-codedex-gold/10">
                  <td className="py-4 px-6 text-white">
                    ...
                    <div className="text-sm text-gray-400">
                      Choose from a catalog of real-world projects
                    </div>
                  </td>
                  <td className="py-4 px-6 text-center">
                    <svg
                ...
                <tr className="border-t border-codedex-gold/10">
                  <td className="py-4 px-6 text-white">
                    ...
                    <div className="text-sm text-gray-400">
                      Get live help from senior devs 24/7 with any coding
                      questions
                    </div>
                  </td>
                  <td className="py-4 px-6 text-center">
        ...
        <div className="mt-24">
          ...
          <div className="text-center mt-8">
            ...
            <Button
              className="bg-codedex-blue text-white hover:bg-codedex-blue/90"
              asChild
            >
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-white/80">
                Commit to your goals with Codedex Club—for as low as
                $7.99/month.
              </p>
            </div>
            <Button
