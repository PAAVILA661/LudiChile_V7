...
export default function ExercisePage({ params }: ExercisePageProps) {
  ...
  const exerciseData = exercisesData[exerciseSlug as keyof typeof exercisesData];
  ...
  return <ExerciseClient exerciseData={exerciseData} exerciseSlug={exerciseSlug} />;
}

function ExerciseNotFound() {
  return (
    <div className="min-h-screen bg-codedex-darkNavy flex flex-col items-center justify-center">
      <h1 className="text-3xl font-pixel text-codedex-gold mb-4">Exercise Not Found</h1>
      <p className="text-gray-300 mb-6">Sorry, we couldn't find the exercise you're looking for.</p>
      <Button asChild>
