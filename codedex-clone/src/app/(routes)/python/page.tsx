        ...
        <div className="lg:col-span-4 space-y-8">
          <CourseSidebar
            ...
            cheatSheets={[
              {
                id: "cheat-1",
                title: "Python functions and concepts",
                unlocksAfter: 4,
                isUnlocked: false,
              },
              {
            ...
            projects={[
              {
                ...
                image: "https://ext.same-assets.com/1748103887/322324277.gif",
              },
              {
                id: "proj-2",
          ...
          <div className="bg-gradient-to-r from-codedex-purple to-codedex-blue rounded-lg overflow-hidden">
            <div className="p-6">
              ...
              <p className="text-white/80 text-sm mb-4">
                Want to take your learning to the next level? Get full access to
                all courses and more for as low as $7.99 / month.
              </p>
              <Button
