  ...
  return (
    <div className="min-h-screen bg-codedex-darkNavy text-white p-8">
      <div className="codedex-container">
        <h1 className="text-3xl font-pixel text-codedex-gold mb-8">
          Admin Dashboard
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-codedex-navy p-6 rounded-lg shadow-lg">
            <h2 className="text-xl font-semibold text-codedex-teal mb-3">
              User Management
            </h2>
          ...
          <div className="bg-codedex-navy p-6 rounded-lg shadow-lg">
            ...
            <p className="text-gray-400 mb-4">
              Edit content for pages like About, Terms, Privacy.
            </p>
            <Button
              variant="outline"
              className="border-codedex-teal text-codedex-teal hover:bg-codedex-teal/10"
